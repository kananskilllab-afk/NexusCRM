...
body{font-family:'Poppins',sans-serif;background:#fff;color:#1A1A2E;font-size:14px;position:relative;min-height:100vh}
.hdr{background:#ffffff;color:#1A1A2E;padding:28px 40px;display:flex;justify-content:space-between;align-items:flex-start;border-bottom:2px solid #393185}
.hdr-meta{text-align:right;font-size:11px;color:#454C66;line-height:1.7}
...
.kpi{border:1px solid #E5E7EB;border-radius:10px;padding:18px;text-align:center;background:#fff}
...
<div class="hdr"><div><img src="/logo.png" alt="Logo" style="height:45px;object-fit:contain;"/></div>
<div class="hdr-meta"><div>${BRAND.address}</div><div>GSTIN: ${BRAND.gstin} &middot; ${BRAND.email}</div>
<div style="margin-top:6px;font-size:12px;font-weight:700;color:#393185;">Performance Report &middot; ${today}</div></div></div>
<div class="body">
<div class="kpi-row">
